        ...
        <div class="card shadow p-4 w-100" style="max-width: 600px;">
            ...
            <div class="container">
                <p class="text-secondary">
                    Lorem ipsum dolor sit amet consectetur adipisicing elit. Eveniet dignissimos laborum velit facilis.
                </p>
                ...
                <p class="text-muted mt-4">Vote ditutup pada dd/mm/yyyy --:--</p>
                <div class="row ">
                    <div class="col">
                        <a href="/hasilvote" class="btn btn-primary btn-sm">Vote</a>
                        <button class="btn btn-success btn-sm">Hasil</button>
                    </div>
